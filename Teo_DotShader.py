...
def makeTemplate(textures):
    ...
    cmds.setAttr(colorcorrect + '.saturation',2)
    cmds.setAttr(colorcorrect + '.contrast', 2.2)
    ...
    connectNode(blendcolor, '.output', aitoon, '.emissionColor')
    connectNode(colorcorrect, '.outColor', blendcolor, '.color1')
    connectNode(projection, '.outColor', blendcolor, '.color2')
